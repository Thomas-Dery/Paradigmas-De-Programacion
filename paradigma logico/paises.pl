...
limita(Pais, argentina). ---devuelve--- Pais = peru ; Pais = brasil. 
limita(P, P2). ---devuelve--- todos los paises con sus limites
limita(argentina, peru). ---devuelve--- true
limita(argentina, ruusia). ---devuelve--- false
limita(_, peru). ---devuelve--- si algun pais limita con peru devuelve true
limita(_, _). ---devuelve--- si algun pais limita con otro devuelve true
