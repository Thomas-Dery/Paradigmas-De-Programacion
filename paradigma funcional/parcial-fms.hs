...
-- tomarUltimas :: Int -> String -> String
...
-- type Jurado = [((PuestaEnEscena -> Bool),Int)]
...
-- puntajePuestaEnEscena :: Estilo -> Jurado -> PuestaEnEscena -> Int
